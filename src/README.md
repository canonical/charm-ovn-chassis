...
Please refer to the [OVN Configuration][ovn-cdg-cfg] in the [OpenStack Charms Deployment
...
[ovn-cdg-cfg]: https://docs.openstack.org/project-deploy-guide/charm-deployment-guide/latest/app-ovn.html#configuration
