...
Please refer to the [OVN Configuration][ovn-cdg] in the [OpenStack Charms Deployment
...
[ovn-cdg]: https://docs.openstack.org/project-deploy-guide/charm-deployment-guide/latest/app-ovn.html#configuration
